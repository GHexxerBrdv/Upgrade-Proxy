...
import {ImplementationV1} from "../../src/UUPSUpgredeableProxy/ImplementationV1.sol";

contract ImplementationV1Test is Test {
    ImplementationV1 auction;
    address seller = makeAddr("seller");
    user hacker;

    function setUp() public {
        auction = new ImplementationV1(seller, "Buy Hoodie", 1 ether, 20, 7, 0.5 ether);
        hacker = new user();
    }
